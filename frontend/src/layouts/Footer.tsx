        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-4">
          {/* Logo and Social Media */}
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-bold text-blue-900">10000IDEAS</span>
              </div>
            
            <div>
              <h3 className="text-xs font-semibold text-gray-700 mb-2">Follow us on social media</h3>
              <div className="flex space-x-2">
                <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-md">
                  <FaFacebookF className="text-white text-sm" />
                </div>
                <div className="w-8 h-8 bg-gradient-to-br from-pink-500 to-purple-600 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-md">
                  <FaInstagram className="text-white text-sm" />
                </div>
                <div className="w-8 h-8 bg-gradient-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-md">
                  <FaPinterest className="text-white text-sm" />
                </div>
                <div className="w-8 h-8 bg-gradient-to-br from-black to-gray-800 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-md">
                  <FaTwitter className="text-white text-sm" />
                </div>
                <div className="w-8 h-8 bg-gradient-to-br from-red-600 to-red-700 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-md">
          ...
          {/* About */}
          <div>
            <h3 className="text-xs font-semibold text-gray-700 mb-2">ABOUT</h3>
            <ul className="space-y-1 text-xs text-gray-600">
          ...
          {/* More */}
          <div>
            <h3 className="text-xs font-semibold text-gray-700 mb-2">MORE</h3>
            <ul className="space-y-1 text-xs text-gray-600">
